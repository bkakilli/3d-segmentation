...
from datasets import s3dis, semantic3d, scannet, modelnet

def get_loaders(args):
    
    if args.dataset == "s3dis":
        train_d, valid_d, test_d = s3dis.get_sets("data/s3dis", args.prefix, training_augmentation=(not args.no_augmentation))
